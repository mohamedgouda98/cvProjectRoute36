...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="{{asset('UserAssets/assets/vendor/perfect-scrollbar/css/perfect-scrollbar.css')}}">

  <link rel="stylesheet" type="text/css" href="{{asset('UserAssets/assets/vendor/nice-select/css/nice-select.css')}}">

  <link rel="stylesheet" type="text/css" href="{{asset('UserAssets/assets/vendor/fancybox/css/jquery.fancybox.min.css')}}">
    ...
    <div class="container py-5">
      <div class="row">
        ...
        <div class="col-lg-6 offset-lg-1 wow fadeInRight">
          ...
          <a class="btn btn-theme-outline" href="{{asset('cv/' . $about->cv)}}" download>Download CV</a>
        </div>
      </div>
    </div>
    <div class="container py-5">
      ...
      <div class="filterable-button py-3 wow fadeInUp" data-toggle="selected">
        <button class="btn btn-theme-outline selected" data-filter="*">All</button>
          @foreach($portfolioCategories as $portfolioCategory)
              <button class="btn btn-theme-outline" data-filter=".{{$portfolioCategory->data_filer_name}}">{{$portfolioCategory->name}}</button>
          @endforeach
      </div>

      <div class="gridder my-3">
          @foreach($portfolios as $portfolio)
              <div class="grid-item {{$portfolio->category->data_filer_name}} wow zoomIn">
                  <div class="img-place" data-src="{{asset('portfolio/' . $portfolio->image)}}" data-fancybox data-caption="<h5 class='fg-theme'>Mobile Travel App</h5> <p>Travel, Discovery</p>">
