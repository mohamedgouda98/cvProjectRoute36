                                ...
                                <div class="widget-content widget-content-area">
                                    <form method="post" action="{{route('admin.service.update')}}">
                                        ...
                                        <div class="input-group mb-4">
                                            ...
                                            <input type="text" class="form-control" name="title" value="{{$service->title}}" aria-label="Username">
                                        </div>
                                        ...
                                        <div class="input-group mb-4">
                                            ...
                                            <input type="text" class="form-control" name="icone" value="{{$service->icone}}" aria-label="Username">
                                        </div>
                                        ...
                                        <div class="input-group mb-4">
                                            ...
                                            <input type="text" class="form-control" name="body" value="{{$service->body}}" aria-label="Username">
                                        </div>
